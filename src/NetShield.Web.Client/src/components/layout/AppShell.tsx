 ...
 *
 * The toast region is here rather than at the composition root so that it sits inside the
 * guard: a confirmation belongs to a signed-in session, and nothing outside one raises a toast.
 */
