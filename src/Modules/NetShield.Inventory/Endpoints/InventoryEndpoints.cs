...
/// </summary>
/// <remarks>
/// The module now serves four resources — devices, credential profiles, the assignment between
/// them, and the internal collector contract — and CONVENTIONS.md §2 asks for one file per
/// resource behind one <c>Map{Module}Endpoints</c> extension. This is that extension. The
/// composition root calls it and nothing else, which is also what keeps
/// <c>ApiDocumentParityTests</c> comparing one name per module rather than a list that grows with
/// every resource.
///
