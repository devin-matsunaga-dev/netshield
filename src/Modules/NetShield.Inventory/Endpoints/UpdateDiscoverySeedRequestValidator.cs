...
/// <summary>Shape validation for <see cref="UpdateDiscoverySeedRequest"/> (CONVENTIONS.md §4).</summary>
public sealed class UpdateDiscoverySeedRequestValidator : AbstractValidator<UpdateDiscoverySeedRequest>
{
    public UpdateDiscoverySeedRequestValidator(IOptions<DiscoveryOptions> options)
    {
